...
class PatchEmbed(nn.Module):  # pylint: disable=E0102
...
class Block(nn.Module):  # pylint: disable=E0102
    def __init__(
        self,
        dim,
        num_heads,
        ...
        self.attn = Attention(
            ...
            num_heads=num_heads,
            qkv_bias=qkv_bias,
            # qk_scale=qk_scale, # pcmbs: discarded after timm=>0.4.5, is an no-op here anyway
            attn_drop=attn_drop,
            proj_drop=drop,
        )
