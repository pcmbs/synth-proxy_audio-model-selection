"""
Taken from https://github.com/fschmid56/EfficientAT/blob/main/models/dymn/model.py
"""
...
from models.efficientat_2.mn.block_types import InvertedResidualConfig, InvertedResidual
...
def _dymn_conf(
    ...
    **kwargs: Any,
    ...
    inverted_residual_setting = [
        ...
        bneck_conf(
            112, 5, 672, 160 // reduce_divider, use_dy_block[12], activations[12], strides[3], dilation
        ),  # C4
        bneck_conf(
            160 // reduce_divider,
            5,
    ...
    **kwargs: Any,
    ...
    if pretrained_name:
        ...
        if cls_in_state_dict != cls_in_current_model:
            print(
                f"The number of classes in the loaded state dict (={cls_in_state_dict}) and "
